...
var mysql_cluster_markup = "Be careful when restoring the dump from another DB environment (or environment with another replication schema) to the replicated MySQL/MariaDB/Percona solution. Please use the Database Corruption Diagnostic add-on for check after restore, and database Recovery Add-on for fix (if needed). You can also refer to Manual Recovery Guide.";
