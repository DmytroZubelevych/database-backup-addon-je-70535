...
if (resp.result == 11) {
    ...
    var respUpdate = api.env.control.ExecCmdById(storageEnvDomain, session, storageEnvMasterId, toJSON([{"command": "/usr/bin/restic self-update 2>&1 || true", "params": ""}]), false);
